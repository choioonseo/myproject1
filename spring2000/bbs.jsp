...
<body>
	...
	<h3>게시물등록 화면입니다.</h3>
	<hr color="red">
	<form action="insert22.multi" method="get">
	...
	<h3>게시물수정 화면입니다.</h3>
	<hr color="red">
	<form action="update22.multi" method="get">
	...
	<h3>게시물삭제 화면입니다.</h3>
	<hr color="red">
	<form action="delete22.multi" method="get">
	...
	<hr color="red">
	<h3>게시물검색 화면입니다.</h3>
	<a href="list22">모든 게시판 리스트 가지고 오기</a>
	<hr color="red">
	<a href="one22.multi?no=1">1번 검색</a>
	<form action="one22.multi" method="get">
